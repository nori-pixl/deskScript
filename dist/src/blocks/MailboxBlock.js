...
exports.processOutboxSend = processOutboxSend;
exports.processInboxReceive = processInboxReceive;
// 8a. outbox:send(key, value) デスク間メッセージ送信
function processOutboxSend(content, hostScope, disScope, ctx) {
...
function processInboxReceive(content, ctx) {
